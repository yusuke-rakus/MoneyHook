...
VALUES
    (2, 'スーパーアルプス', -3000, '2022-06-01', 1, 1, false),
    (2, 'スーパーアルプス', -1800, '2022-06-08', 1, 1, false),
    (2, 'カフェくるくま', -1200, '2022-06-13', 2, 104, false),
    (2, 'スーパーアルプス', -3000, '2022-06-15', 1, 1, false),
    (2, 'ルームサンダル', -3800, '2022-06-17', 5, 11, false),
    (2, 'スーパーアルプス', -5200, '2022-06-22', 1, 1, false),
    (2, 'タバコ', -550, '2022-06-25', 3, 7, false),
    (2, '家賃', -78550, '2022-06-25', 22, 82, TRUE),
    (2, 'Youtube', -1000, '2022-06-28', 7, 105, TRUE),
    (2, 'Amazon', -500, '2022-06-28', 7, 106, TRUE),
    (2, 'Youtube', -1000, '2022-07-28', 7, 105, TRUE),
    (2, 'Amazon', -500, '2022-07-28', 7, 106, TRUE),
    (2, 'Youtube', -1000, '2022-08-28', 7, 105, TRUE),
    (2, 'Amazon', -500, '2022-08-28', 7, 106, TRUE),
    (2, 'Youtube', -1000, '2022-09-28', 7, 105, TRUE),
    (2, 'Amazon', -500, '2022-09-28', 7, 106, TRUE),
    (2, 'Youtube', -1000, '2022-10-28', 7, 105, TRUE),
    (2, 'Amazon', -500, '2022-10-28', 7, 106, TRUE),
    (2, 'Youtube', -1000, '2022-11-28', 7, 105, TRUE),
    (2, 'Amazon', -500, '2022-11-28', 7, 106, TRUE),
    (2, 'Youtube', -1000, '2022-12-28', 7, 105, TRUE),
    (2, 'Amazon', -500, '2022-12-28', 7, 106, TRUE);
