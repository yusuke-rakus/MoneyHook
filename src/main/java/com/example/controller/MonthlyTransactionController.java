...
public class MonthlyTransactionController {
	...
	public EditFixedResponse editFixed(@RequestBody @Validated EditFixedForm form,
	...
	public EditOneFixedResponse editOneFixed(@RequestBody @Validated EditOneFixedForm form,
			BindingResult result) throws SystemException {
